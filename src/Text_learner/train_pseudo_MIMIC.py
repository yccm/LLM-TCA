...
# Load data
df_pseudo = pd.read_csv("dataset/MIMIC/MIMIC_tabular/pseudo_outcomes.csv")
# load representations
df_rep = pd.read_csv("dataset/MIMIC/MIMIC_ALL_embeddings.csv")
df = pd.read_csv("dataset/MIMIC/MIMIC_tabular/MIMIC_syn.csv")
