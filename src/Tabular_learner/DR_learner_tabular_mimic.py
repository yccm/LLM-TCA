...
def load_and_check_data(path):
    ...
    df_train = pd.read_csv(f"{path}/MIMIC_syn_train.csv")
    df_test = pd.read_csv(f"{path}/MIMIC_syn_test.csv")
    # # Propensity score based on sigmoid
    # df_train = pd.read_csv(f"{path}/MIMIC_syn_sigmoid_train.csv")
    # df_test = pd.read_csv(f"{path}/MIMIC_syn_sigmoid_test.csv")
...
# # Randomly assign treatment
X_train, Y0_train, Y1_train, A_train, X_test, Y0_test, Y1_test, A_test = load_and_check_data(path="dataset/MIMIC/MIMIC_tabular/MIMIC_syn_random")

# Propensity score based on sigmoid
#X_train, Y0_train, Y1_train, A_train, X_test, Y0_test, Y1_test, A_test = load_and_check_data(path="dataset/MIMIC/MIMIC_tabular/MIMIC_syn_sigmoid")
